      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center">
            ...
            {/* <h2 className='text-[10px] p-1 px-2 rounded-full bg-blue-600 text-white'>20 Dec 2024</h2>x */}
          </div>
          <h2 className="mt-3 font-medium  text-lg">
            {course?.courseLayout?.[0]?.courseTitle ||
              course?.courseLayout?.courseTitle}
          </h2>
          <p className="text-sm line-clamp-2 mt-2">
            {course?.courseLayout?.[0]?.courseSummary ||
